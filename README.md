...
Реализация тестового задания на позицию Junior Developer. Описание задания находится находится по адресу ./task_description/Junior_Developer_task_description.txt
